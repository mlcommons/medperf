...
COL1="medperf mlcube run --mlcube ./mlcube_col1 --task train -e COLLABORATOR_CN=col1@example.com"
COL2="medperf mlcube run --mlcube ./mlcube_col2 --task train -e COLLABORATOR_CN=col2@example.com"
COL3="medperf mlcube run --mlcube ./mlcube_col3 --task train -e COLLABORATOR_CN=col3@example.com"
