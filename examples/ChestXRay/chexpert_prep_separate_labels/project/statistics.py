...
class Stats:
    def __init__(self, data_path, labels_path, out_file, params):
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--labels_path", "--labels-path", type=str, required=True, help="labels path"
    )
    parser.add_argument(
        "--params_file",
        "--params-file",
    ...
    checker = Stats(args.data_path, args.labels_path, stats_path, params)
    checker.run()
