...
The client communicates to the server through the API to, for example, authenticate a user, retrieve benchmarks/containers/models metadata and send results.
