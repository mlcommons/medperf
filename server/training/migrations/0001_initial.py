    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_preparation_mlcube', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='training_exp', to='mlcube.mlcube')),
                ('fl_mlcube', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='fl_mlcube', to='mlcube.mlcube')),
