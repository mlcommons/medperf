...
def create_benchmark_ref_model_and_metrics_containers(
    ...
    return reference_model_executor_mlcube, data_evaluator_mlcube
...
def create_benchmark(
    ...
    print(
        "#################BENCHMARK WITH DATA PREPARATION CONTAINER###################"
    )
...
def create_workflow_benchmark(
    ...
    data_preprocessor_mlcube = api_server.request(
        ...
        benchmark_owner_token,
        {
            ...
            "image_tarball_hash": "",
            "image_hash": {
                "mlcommons/chestxray-tutorial-prep:0.0.1": "d941e09d160bba3cf5c09b48f490e3b9e891597341e560954ff7512478eaef22"
            },
            "additional_files_tarball_url": "",
            "additional_files_tarball_hash": "",
            "metadata": {
    ...
    print(
        "Data Preprocessor Workflow Created(by Benchmark Owner). ID:",
        data_preprocessor_mlcube,
    )
    ...
    print(
        "Data Preprocessor Workflow state updated to",
        data_preprocessor_mlcube_state,
        "by Benchmark Owner",
    )
...
def create_model(api_server, model_owner_token):
    print("##########################MODEL OWNER##########################")
    ...
    return model_executor1_mlcube


def associate_model_to_benchmark(
    api_server,
    model_owner_token,
    benchmark_owner_token,
