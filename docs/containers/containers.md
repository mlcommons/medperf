...
This container interface should expose the following entrypoints:
...
- **Statistics:** computes statistics on the prepared data and writes them to `/mlcommons/volumes/statistics/statistics.yaml`.
