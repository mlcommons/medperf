...
print_eval medperf asset submit --name cc-cnn-weights --asset-url $CHESTXRAY_CNN_MODEL --operational
...
echo "====================================="
print_eval medperf asset submit --name cc-mobilenet-weights --asset-path "$DIRECTORY/cnn_weights.tar.gz" --operational
