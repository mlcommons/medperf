...
if [ -z $DATA_PREPROCESSOR_MLCUBE_STATE ]
then
...
if [ -z $REFERENCE_MODEL_EXECUTOR_MLCUBE ]
then
...
if [ -z $REFERENCE_MODEL_EXECUTOR_MLCUBE_STATE ]
then
...
if [ -z $DATA_EVALUATOR_MLCUBE_STATE ]
then
...
if [ -z $MODEL_EXECUTOR1_MLCUBE_STATE ]
then
...
if [ -z $MODEL_EXECUTOR2_MLCUBE_STATE ]
then
...
if [ -z $MODEL_EXECUTOR1_IN_BENCHMARK ]
then
...
if [ -z $MODEL_EXECUTOR1_IN_BENCHMARK_STATUS ]
then
...
if [ -z $MODEL_EXECUTOR2_IN_BENCHMARK ]
then
...
if [ -z $MODEL_EXECUTOR2_IN_BENCHMARK_STATUS ]
then
