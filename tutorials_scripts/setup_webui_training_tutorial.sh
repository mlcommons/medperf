...
url=https://storage.googleapis.com/medperf-storage/chestxray_train_sample.tar.gz
...
mv chestxray_train_sample/dataset_1 sample_raw_data/col1
mv chestxray_train_sample/dataset_2 sample_raw_data/col2
rm -rf chestxray_train_sample
